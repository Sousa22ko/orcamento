...
//           {$resta_pagar=($resta_pagar+$despesa["valor"]);}  // acumula os subtotais das despesas que ainda não foram pagas.
        ...
        if ($despesa["pago"] === '2001-01-01' && !$ignorar) {
            $resta_pagar = ($resta_pagar + $despesa["valor"]);
        }  // acumula os subtotais das despesas que ainda não foram pagas.
        ...
        if ($despesa["pago"] === '2001-01-01' && !$ignorar) {// exclui da soma do total geral os valores da id_despesa entre 33 e 37
