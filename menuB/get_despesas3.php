...
//SELECT orcamento.despesa.*,orcamento.descricao.*,orcamento.categoria.* FROM orcamento.despesa,orcamento.descricao,orcamento.categoria WHERE orcamento.despesa.ocorrencia = '2512' AND orcamento.despesa.id_descricao=orcamento.descricao.id_descricao AND orcamento.despesa.categoria=orcamento.categoria.categoria AND orcamento.despesa.valido='S' ORDER BY orcamento.despesa.categoria , orcamento.despesa.valor DESC;
