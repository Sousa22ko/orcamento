                ...
                {$d['descricao_abreviada']}
                    ...
                    <div class='col-md-6'>
                        <div class='balao-linha'>
                            ...
                            <div class='despesa' style='text-align: letf;'><strong>Categoria</strong></div>
...
<div class="col-md-10">
    <div class="balao">
        <div class="balao-titulo">Resumo Orçamento de '.$meses[$mes].' de '.$ano.'</div>
        ...
        <div class="balao-linha2">
            ...
            <div>Total de Despesas (inclui o VA) → <strong>R$ '.number_format($totalGeral,2,",",".").'</strong></div>
        </div>
...
$resposta .= '
<div>TDif VA - DespBR → <strong>R$ '. number_format($totalVA, 2, ',', '.') .'- R$ '. number_format($totalBrasilia, 2, ',', '.').'= '. $statusDiferenca.'</strong></div>
...
echo json_encode([
   ...
   'salario' => $salario,
    ...
    'resta_pagar_Brasilia' => $resta_pagar_Brasilia,
    'totalGeral' => $totalGeral,
    'totalBrasilia' => $totalBrasilia,
   'totalVA' => $totalVA
   ]);
...
//print_r( $subtotais);
//print_r( $subtotalNome);

print "
<br>Salário mês:".( $salario)."  
<br>Resta Pagar Natal:".( $resta_pagar)."  
<br>Resta Pagar Brasilia: " .( $resta_pagar_Brasilia)."  
<br>Total de Despesas (inclui o VA): " .$totalGeral."
<br>Total Brasilia: " .$totalBrasilia."
<br>Total VA: " .$totalVA
